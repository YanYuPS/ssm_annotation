...
<div class="wrapper" id="index_app">
    ...
    <div class="content-wrapper">
        ...
        <h1 style="text-align: center">
            <%--
                org.springframework.security.core.userdetails.User@2c983f1:
                Username: 11111;
                Password: [PROTECTED];
                Enabled: true;
                ...
                Granted Authorities: ROLE_STUDENT xiaoyi
            --%>
...
<script>
    ...
    var app = new Vue({
        el:"#index_app",//el即element，要渲染的页面元素
        data: {
            sid:"",
            sname:""
        },
